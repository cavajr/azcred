...
class TExtratoContrato extends TPDFDesigner
{
    ...
    {
        $this->SetY(-15);
        $this->Line(18, 560, 825, 560);
        $this->SetFont('Arial', '', 7);
        $this->SetY(565);
        $this->SetTextColor(0, 0, 0);
        $this->Cell(170, 10, utf8_decode('ToolConsig - Sistema de Gestão de Contratos'), 0, 0, true);
        $this->SetX(745);
